...
void HexapodControllerSimple::set_broken(const std::vector<int> broken_legs)
{
    _broken_legs = broken_legs;
}

std::vector<int> HexapodControllerSimple::broken_legs()
{
    return _broken_legs;
}

std::vector<double> HexapodControllerSimple::pos(double t)
{
